...
from lib.transformer_wk import transformer_ours, transformer_wk
...
class STTran(nn.Module):
    ...
    def __init__(self, mode='sgdet',
                 ...
                 enc_layer_num=None, dec_layer_num=None, transformer_mode=None, is_wks=True, feat_dim=2048, motifs_path=None, conf=None):
    ...
    def forward(self, entry):
        ...
        global_output, _, _ = self.glocal_transformer(features=rel_features, im_idx=entry['im_idx'])
